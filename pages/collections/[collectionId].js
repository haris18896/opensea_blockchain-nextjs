  ...
  return (
    <div className='overflow-hidden'>
      ...
      <div className={style.bannerImageContainer}>
        <img className={[style.bannerImage]} src={collection?.bannerImageUrl || 'https://via.placeholder.com/200'} />
      </div>

      <div className={style.infoContainer}>
        <div className={style.midRow}>
          <img className={style.profileImg} src={collection?.imageUrl || 'https://via.placeholder.com/200'} />
        </div>
